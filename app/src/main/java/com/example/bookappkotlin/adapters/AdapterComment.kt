...
//    arraylist
    ...
    override fun onBindViewHolder(holder: HolderComment, position: Int) {
        ...
        //we don't have user name, profile picture but we have user uid, so we will load using tha uid
        loadUserDetails(model,holder)
         //handle click show dialog to delete comment
        holder.itemView.setOnClickListener { 
//            requirements to delete a comment
//            1. user must be loggin
            ...
            .setPositiveButton("DELETE"){d,e->
                ...
                ref.child(bookId).child("Comments").child(commentId)
                    ...
                    .addOnSuccessListener {
                        Toast.makeText(context, "OK. Comment Deleted", Toast.LENGTH_SHORT).show()
                    }
